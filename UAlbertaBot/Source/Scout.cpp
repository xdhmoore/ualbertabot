...
BWAPI::Unit Scout::closestEnemyWorker()
{
...
BWAPI::Unit Scout::getEnemyGeyser()
{
...
bool Scout::enemyWorkerInRadius()
{
	for (auto & unit : BWAPI::Broodwar->enemy()->getUnits())
	{
...
int Scout::getClosestVertexIndex(BWAPI::Unit unit)
{
	int closestIndex = -1;
